...
//=>
 ...
 CircularInt operator= (CircualrInt& a, int const& num){
     CircularInt a1 (a)
     a1.current=range(a1,num);
     return a1;
 }
  CircularInt operator= (CircualrInt& a, CircularInt const& b){
      CircularInt a1 (a)
      a1.current=range(a1,b.current);
      return a1;
  }
// +	
